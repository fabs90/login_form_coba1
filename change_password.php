...
<body>
    <div class="container">
        ...
        <form action="change_password.php" method="POST" class="login-email">
...
?>
            <div class="input-group">
                <input type="text" placeholder="Input Your Token" name="token_confirm" value="" required>
            </div>
            <div class="input-group">
                <input type="password" placeholder="New Password" name="new_password" value="" required>
            </div>
            <div class="input-group">
                <input type="password" placeholder="Confirm New Password" name="password_confirm" value="" required>
            </div>
            <div class="input-group">
                <button name="kirim_new_password" class="btn">Send</button>
            </div>
